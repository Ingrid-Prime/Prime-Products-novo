...
export const defaultArticles: Article[] = [
  ...
  "image": "/images/conteudos/capa-novos-2-corrigida.jpg",
  "category": "Regulação",
...

  {
    ...
    title: 'Conversão de Motor a Diesel para Gás Natural',
    category: 'Engenharia',
    date: '15 Jul 2026',
    summary: 'Análise técnica da conversão de grupos geradores e motores a diesel para sistemas dual-fuel com Gás Natural (GNV), reduzindo emissões e custos operacionais.',
    image: '/images/conteudos/diesel-hidrogenio.png',
    content: '<p class=\"text-lg text-gray-700 mb-6\">A transição energética e a busca por eficiência de custos impulsionam a conversão de grupos geradores e motores pesados a diesel. A conversão de diesel para Gás Natural (GNV/Metano) surge como uma alternativa robusta e testada. Abaixo, detalhamos o comparativo técnico e as vantagens da conversão (Diesel-GNV).</p><h3 class=\"text-2xl font-bold text-secondary mb-4 mt-8 border-l-4 border-primary pl-4\">A Rota Recomendada: Dual-Fuel</h3><p class=\"mb-4\">O gás natural possui alta resistência à detonação e não se autoignita adequadamente na taxa de compressão de um motor diesel convencional. A recomendação da Prime Products é utilizar o sistema Dual-Fuel, preservando o sistema original, usando o <strong>diesel como piloto de ignição</strong> e permitindo uma substituição energética que pode chegar a 70% com Gás Natural.</p><h3 class=\"text-2xl font-bold text-secondary mb-4 mt-8 border-l-4 border-primary pl-4\">Vantagens Técnicas do Gás Natural (GNV)</h3><div class=\"overflow-x-auto mb-6\"><table class=\"min-w-full bg-white border border-gray-200\"><thead class=\"bg-gray-100\"><tr><th class=\"py-2 px-4 border-b text-left\">Propriedade</th><th class=\"py-2 px-4 border-b text-left\">Diesel</th><th class=\"py-2 px-4 border-b text-left\">Gás Natural (GNV)</th><th class=\"py-2 px-4 border-b text-left\">Vantagem na Aplicação</th></tr></thead><tbody><tr><td class=\"py-2 px-4 border-b font-medium\">Emissões de Particulados</td><td class=\"py-2 px-4 border-b\">Altas</td><td class=\"py-2 px-4 border-b\">Praticamente nulas</td><td class=\"py-2 px-4 border-b\">Redução drástica de fumaça preta e fuligem.</td></tr><tr><td class=\"py-2 px-4 border-b font-medium\">Custo Operacional</td><td class=\"py-2 px-4 border-b\">Alto</td><td class=\"py-2 px-4 border-b\">Menor</td><td class=\"py-2 px-4 border-b\">Substituição de até 70% do volume de diesel consumido.</td></tr><tr><td class=\"py-2 px-4 border-b font-medium\">Autonomia (Dual-Fuel)</td><td class=\"py-2 px-4 border-b\">Padrão</td><td class=\"py-2 px-4 border-b\">Estendida</td><td class=\"py-2 px-4 border-b\">O motor pode voltar a operar 100% a diesel caso o gás acabe.</td></tr></tbody></table></div><h3 class=\"text-2xl font-bold text-secondary mb-4 mt-8 border-l-4 border-primary pl-4\">As 5 Frentes Obrigatórias da Conversão</h3><ul class=\"list-disc pl-6 space-y-2 mb-6 text-gray-700\"><li><strong>Armazenamento:</strong> Tanques de alta pressão para GNV operando a 200-250 bar ou alimentação por rede canalizada.</li><li><strong>Alimentação:</strong> Tubulações, válvulas de segurança e reguladores de pressão de alta precisão.</li><li><strong>Admissão:</strong> Instalação de misturadores ar-gás antes ou depois do turbocompressor, dependendo da arquitetura.</li><li><strong>Combustão:</strong> Calibração fina da taxa de mistura (Diesel/GNV) de acordo com a carga do motor para evitar <em>knocking</em> (detonação).</li><li><strong>Controle:</strong> ECU dedicada (módulo Dual-Fuel) para mapeamento de injeção, monitoramento de EGT (temperatura de escape) e <em>fallback</em> para 100% diesel.</li></ul><div class=\"bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg mt-8\"><h4 class=\"text-lg font-bold text-blue-900 mb-2\">A Engenharia da Prime Products</h4><p class=\"text-blue-800\">A vantagem competitiva da Prime é o conhecimento especializado. Oferecemos válvulas, reguladores de pressão e sistemas de segurança essenciais para a infraestrutura de Gás Natural Veicular e Estacionário, garantindo conversões eficientes, regulamentadas e seguras.</p></div>'
  },
  {
    id: 'instrumentacao-analitica-utilidades',
    title: 'Instrumentação Analítica: A Ciência por Trás da Infraestrutura',
    category: 'Analítica',
    date: '14 Jul 2026',
  ...
  },
  {
    ...
    title: 'Engenharia aplicada: Otimizando processos industriais',
    category: 'Engenharia',
    date: '28 Fev 2025',
  ...
  },
  {
    ...
    title: 'Garantindo confiabilidade operacional em 5 passos',
    category: 'Manutenção',
    date: '15 Fev 2025',
  ...
  },
  {
    ...
    title: 'Boas práticas em calibração de instrumentos analíticos',
    category: 'Qualidade',
    date: '10 Fev 2025',
  ...
  },
  {
    ...
    title: 'Diferença entre análise de processo e análise laboratorial',
    category: 'Analítica',
    date: '02 Fev 2025',
  ...
  },
  {
    ...
    title: 'Conformidade e rastreabilidade: Por que documentar?',
    category: 'Normas',
    date: '25 Jan 2025',
  ...
  },
  {
    ...
    title: 'Tendências em instrumentação para o próximo ano',
    category: 'Inovação',
    date: '15 Jan 2025',
