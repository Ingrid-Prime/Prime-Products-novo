export const OXYGEN_GENERATION_CATALOG = [
  {
    title: 'Modular Oxygen Generators (O200 Nordic Series)',
    columns: ['Ref Visual', 'Modelo', 'Capacidade (Nm³/h)', 'Pureza (%)', 'Pressão (bar)', 'Dimensões (mm)'],
    rows: [
      ['<img src="/images/produtos/geracao-de-oxigenio/oxymat-200-series-solution.png" class="h-16 object-contain rounded-sm mx-auto mix-blend-multiply" />', 'O200-2', '36.4 - 83.5', '93%', '4.0 - 6.0', '1973x934x2237'],
      ['<img src="/images/produtos/geracao-de-oxigenio/oxymat-200-series-solution.png" class="h-16 object-contain rounded-sm mx-auto mix-blend-multiply" />', 'O200-3', 'Sob consulta', '93%', '4.0 - 6.0', '2449x934x2237'],
      ['<img src="/images/produtos/geracao-de-oxigenio/oxymat-200-series-solution.png" class="h-16 object-contain rounded-sm mx-auto mix-blend-multiply" />', 'O200-4', 'Sob consulta', '93%', '4.0 - 6.0', '2922x934x2237'],
      ['<img src="/images/produtos/geracao-de-oxigenio/oxymat-200-series-solution.png" class="h-16 object-contain rounded-sm mx-auto mix-blend-multiply" />', 'O200-5', 'Sob consulta', '93%', '4.0 - 6.0', 'Expansível']
    ]
  },
  {
...
export const OXYGEN_GENERATION_EXTRA_BLOCKS = [
  {
    ...
    list: [
      ...
      'Sistemas Compactos (gabinetes) para espaços reduzidos.',
      'Containerizados 100% autônomos para ambientes inóspitos.',
      'Modularidade O200: Aumente a capacidade adicionando módulos, sem trocar o sistema inteiro.'
    ],
    warning: 'Nota: A configuração exata de vazão, pureza e pressão de cada modelo varia de acordo com o dimensionamento da rede de ar comprimido. Consulte nossa engenharia.'
  }
];
