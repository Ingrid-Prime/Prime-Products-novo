...
const SOLUTIONS = [
  ...
  { icon: Gauge, id: 'sol_10', label: 'Reguladores Especiais', path: '/produto/reguladores-especiais', desc: 'Reguladores de alta performance para gases especiais e calibração.', img: '/images/produtos/aplicacao real.webp' },
];
